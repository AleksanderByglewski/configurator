...
class UconfigsController extends genericGarageController {
    ...
    determineState() {
        ...
        switch (object_type) {
            case 'kostka':
                object_width = object_width * 0.75; // You can adjust this value for your requirement
                object_height = 30 * object_height * 0.75; // and this
                object_depth = object_depth * 0.75; // and this
                break;
