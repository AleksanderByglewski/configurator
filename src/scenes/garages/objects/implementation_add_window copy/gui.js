...
class UconfigImplementationGui extends genericGui {
    ...
    initialGeneration(){
        ...
        DoorSystem1.state.state['name']="Brama frontowa2" ;
...
class UconfigImplementationWindowGui extends genericGui {
    constructor() {
        super();
    }
 ...
 export{UconfigImplementationGui, UconfigImplementationWindowGui}