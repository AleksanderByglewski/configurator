...
class FloorObject extends genericObject {
    constructor() {
        super();
    }
    create(attributes={}) {
        ...
        let color = (attributes && attributes.color) ? attributes.color : "#fff";
        ...
        let repeat_x= (attributes && attributes.height) ? parseFloat(attributes.repeat_x) : 1;
        let repeat_y= (attributes && attributes.height) ? parseFloat(attributes.repeat_y) : 1;
        ...
        local_texture.repeat.set(repeat_x,repeat_y)

   
        let material_type=(attributes && attributes.material_type) ? attributes.material_type : "floor_type_1";
        local_texture=loader.load('/assets/textures/foundation/foundation1.jpg');
        switch(material_type){
            case "floor_type_1":
                ...
                case "floor_type_3":
                    ...
                    local_texture=loader.load('/assets/textures/foundation/foundation3.jpg');
                ...
                case "floor_type_4":
                    ...
                    local_texture=loader.load('/assets/textures/foundation/foundation4.jpg');
                    local_texture.repeat.set(repeat_x, repeat_y);
                ...
                case "floor_type_5":
                    ...
                    local_texture=loader.load('/assets/textures/foundation/foundation5.jpg');
                    local_texture.repeat.set(repeat_x, repeat_y);
        ...
        local_texture.wrapS = THREE.RepeatWrapping;
        local_texture.wrapT = THREE.RepeatWrapping;
        local_texture.repeat.set(5, 5); // Set the repeat values to 5x5
...
export {SphereObject, RoofSideLeftObject, RoofSideRightObject,RoofSideSquareObject, RoofTopObject, FloorObject}
