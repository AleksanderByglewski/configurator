...
function loadCustomTextureMaterial(path = '/assets/textures/roof_tile_14/', resolution = "1k") {
  const loader = new THREE.CubeTextureLoader();
  loader.setPath('/assets/textures/cube/Bridge2/');
  let textureEquirec, textureCube;
  textureCube = loader.load(['posx.jpg', 'negx.jpg', 'posy.jpg', 'negy.jpg', 'posz.jpg', 'negz.jpg']);
  ...
  sphereMaterial.map.wrapS = THREE.MirroredRepeatWrapping;
  sphereMaterial.map.wrapT = THREE.MirroredRepeatWrapping;



  sphereMaterial.normalMap.wrapS = THREE.MirroredRepeatWrapping;
  sphereMaterial.normalMap.wrapT = THREE.MirroredRepeatWrapping;

  sphereMaterial.bumpMap.wrapS = THREE.MirroredRepeatWrapping;
  sphereMaterial.bumpMap.wrapT = THREE.MirroredRepeatWrapping;
...
// let global_metal_tiling = load_texture_tiling('/assets/textures/roof_tile2/grey_roof_tiles_02_', '1k')
const global_metal_tiling = loadCustomTextureMaterial()
...
function select_texture(args) {
  ...
  if (debug) {
    ...
    material_output.bumpScale=4;
    material_output.normalScale= new THREE.Vector2(4.5, 4.5)
  ...
  switch (material_type) {
    ...
    case "material_type_8":
      ...
      material_output.map.repeat.set(0.5* width, height);
      material_output.bumpMap.repeat.set(0.5 * width, height);
      material_output.normalMap.repeat.set(0.5 * width, height);
      material_output.color = new THREE.Color(color)
    ...
    case "material_type_9":
      material_output.bumpMap.repeat.set(t14_scaling * width, height);
      material_output.normalMap.repeat.set(t14_scaling * width, height);
      //  color ="#ee2797";
      // local_texture=global_texture.clone();
      // local_texture.wrapS=THREE.RepeatWrapping
      // material_output.bumpMap.rotation = Math.PI / 2;
