...
class UconfigImplementationGateGui extends genericGui {
    constructor() {
        super();
    }
     generateSep(){
    ...
    createMarkup() {
        ...
        const attributes = ['position_x','width', 'height'];
        ...
        removeModelBtn.addEventListener('click', function () {
            // Call notifyMediator with 'recursivelyRemoveModel' event
            this.notifyMediator('recursivelyRemoveModel');
            const element=document.getElementById('parent-inputs-accordion-' + this.id)
...
//         text_attributes=Object.keys(this.mediator.state.state)
...
//             const textInput = document.createElement('input');
//             textInput.type = 'text';
//             textInput.value = this.mediator.state.state[attr] || 'State name';  // default to empty string if not set
...
//     }
// }
// export{UconfigGui,UconfigInvisibleGui, UconfigDebugGui}
 export{UconfigImplementationWallGui, UconfigImplementationGateGui}