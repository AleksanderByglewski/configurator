...
import {global_texture, loader} from '../base/texture'
...
class FloorObject extends genericObject {
    ...
    create(attributes={}) {
        ...
        let repeat_x= (attributes && attributes.height) ? parseFloat(attributes.repeat_x) : 0;
        let repeat_y= (attributes && attributes.height) ? parseFloat(attributes.repeat_y) : 0;
