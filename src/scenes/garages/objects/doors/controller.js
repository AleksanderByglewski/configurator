...
import { DoubleCubeObject,CubeObject,AdditionalObject,UconfigObject, UconfigInvisibleObject,WallGarageObject, genericGarageObject } from '../default/object'
...
class CubeController extends genericGarageController {
    constructor() {
        super();
        this.setModel(AdditionalObject)
    }
    handleEvent(event, data) {
        switch (event) {
            case 'removeModel':
