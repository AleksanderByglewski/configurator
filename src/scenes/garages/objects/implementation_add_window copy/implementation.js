...
class UconfigsImplementationWindowController extends UconfigsImplementationController {
    constructor() {
        super()
        this.setModel(UconfigInvisibleObject)
...
export {  UconfigsImplementationController, UconfigsImplementationWindowController}