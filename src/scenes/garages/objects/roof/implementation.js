...
import { SupportSquareGarageController,SupportGarageController,GableGarageController, SimpleController, SimpleRedController} from './controller'
...
class UconfigsImplementationController extends UconfigsController {
    ...
    generatePassiveObjects(){
            ...
            let array = [
                { objectOptions: accessersWallFront, classInstance:GableGarageController},
                { objectOptions: accessersWallBack, classInstance: SupportGarageController  },
                { objectOptions: accessersWallLeft, classInstance: SupportGarageController  },
                { objectOptions: accessersWallRight, classInstance: SupportSquareGarageController }
                ]
            return array
    }
