...
class DedicatedGui extends genericGui {
    constructor() {
        super();
    }
    ...
    createMarkupType() {
        ...
        const squareButtons = [
            { value: 'gate_type_1', display_value: "Brama uchylna ", display_image: '/assets/display/material/1.jpg' },
            { value: 'gate_type_2', display_value: "Brama dwudrzwiowa", display_image: '/assets/display/material/2.jpg' },
            { value: 'gate_type_3', display_value: "Brama uchylna", display_image: '/assets/display/material/3.jpg' },
 ...
 export{UconfigImplementationDoorGui, DedicatedGui }