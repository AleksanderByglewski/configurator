...
import { accesser, GLOBAL_ORIENTATION } from '../../base.js'
import * as THREE from 'three';
import { RoundedBoxGeometry } from 'three/examples/jsm/geometries/RoundedBoxGeometry.js';
import { Generic, genericGui, genericState, genericObject, genericDisplay, genericController } from '../../base.js'
import { CubeObject,UconfigObject,WallGarageObject, UconfigInvisibleObject, genericGarageObject } from '../base/object.js'
import { UconfigInvisibleGui,UconfigGui, UconfigDebugGui } from '../base/gui.js'
import { UconfigController,CubeController, RedCubeController,WallGarageController,groupGenericGarageController,genericGarageController } from '../base/controller.js'
import { UconfigsController } from '../base/controller.js'
 
import { UconfigImplementationGui, UconfigImplementationWindowGui} from './gui.js'
...
class UconfigsImplementationGutterController extends UconfigsImplementationController {
    constructor() {
        super()
        this.setModel(UconfigInvisibleObject)
        this.gui = new UconfigImplementationWindowGui();
        this.gui.set_mediator(this)
        this.group = new THREE.Group()
        this.external_objects=[]
        this.external_objects_controllers=[]
...
export {  UconfigsImplementationController,  UconfigsImplementationGutterController}